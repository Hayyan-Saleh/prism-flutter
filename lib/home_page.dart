...
class HomePageState extends State<HomePage> {
  ...
  void _showSettingsBottomSheet(BuildContext ctx) {
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  final pAccountBloc = context.read<PAccountBloc>();
                  final personalAccount = pAccountBloc.pAccount;
                  pAccountBloc.add(LoadRemotePAccountEvent());
                  navigator.pop();
                  Future.microtask(() {
                    navigator.pushNamed(
                      AppRoutes.updateAccount,
                      arguments: {'personalAccount': personalAccount},
                    );
                  });
                },
              ),
